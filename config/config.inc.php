...
// SQL DATABASE
$config['db_dsnw'] = 'mysqli://roundcube:xQoGEbDIKoc3CdrYzUHXwdM3cvbOZY@127.0.0.1:3306/roundcubemail';
...
$config['des_key'] = 'EdJLfUSjE7JwvWnq7g4QcqwY';
$config['cipher_method'] = 'AES-256-CBC';
$config['useragent'] = 'Roundcube Webmail'; // Hide version number
//$config['username_domain'] = 'aone.social';
